...
<head>
    ...
    <title>Eduk Learning Management System - Object Oriented Programming with C++</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <header>
        ...
        <p>Combines procedural programming with OOP concepts</p>
    ...
    <div class="container">
        <section id="introduction">
            <h2>Introduction</h2>
            <p>Welcome to the "Object Oriented Programming with C++" course. In this course, you'll learn how to combine procedural programming with Object-Oriented Programming (OOP) concepts, laying a solid foundation for future advanced programming topics.</p>
            <p>The course is taught by <strong>Govinda Subedi</strong>, a skilled programmer with vast experience in C++ and OOP.</p>
        </section>
            ...
            <div class="about-box">
                <div>
                    ...
                    <ul>
                        ...
                        <li>Learn C++ syntax and key OOP concepts</li>
                        <li>Integrate procedural and object-oriented programming</li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        ...
                        <li>C++ specific features like templates and exceptions</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            ...
            <p>Email: <a href="mailto:govinda.subedi@university.com">govinda.subedi@university.com</a></p>
            <p>Office: Room 102, Computer Science Department</p>
        </section>
    </div>
